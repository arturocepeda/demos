...
LOCAL_MODULE            := Light
LOCAL_C_INCLUDES        := $(LOCAL_PATH) $(LOCAL_PATH)/../../../../../GameEngine $(LOCAL_PATH)/../../../source/03_Light
LOCAL_SRC_FILES         := Android.cpp AssetManager.cpp ../../../source/03_Light/StateSample.cpp
