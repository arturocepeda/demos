...
extern "C"
{
   ...
   JNIEXPORT void JNICALL Java_com_GameEngine_Light_GameEngineLib_Pause(JNIEnv* env, jobject obj);
   JNIEXPORT void JNICALL Java_com_GameEngine_Light_GameEngineLib_Resume(JNIEnv* env, jobject obj);
